...
const SPREADSHEET_ID = "1Ptjij3SeHh28NOZeeTXECBedaeffgrWan9AA4Ed57zc";

console.log("Working directory:", __dirname);

const LOCALES_FOLDER = path.resolve(__dirname, "../../locales");
const globs = path.resolve(process.cwd(), "src/**/*.{ts,tsx}");

// 1 - Download spreadsheet from https://docs.google.com/spreadsheets/d/1Ptjij3SeHh28NOZeeTXECBedaeffgrWan9AA4Ed57zc/edit#gid=0
async function main() {
